...
def enzyme_assay_run():
    ...
    if user_continue:
        ...
        while True:
            ...
            file_path = 'C:\\Users\\GormleyLab\\Desktop\\Senior Design 2024\\GOx_1_31_25\\absorbance.xml'

            ei_comp,r2_score = dp.find_next(file_path, synthesized_wells,'all_combinations.csv')
            print(r2_score)
            print(ei_comp)
